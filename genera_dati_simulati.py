...
CAMPAGNE = {
    # ---- Google Ads (6) -----------------------------------------------------
    "RND_IT_GOOGLE_SEARCH_BRAND":     dict(canale="Google Ads", quota=0.12, cpm=30.0, ctr=0.075, qualita=1.15),
    "RND_IT_GOOGLE_SEARCH_GENERICA":  dict(canale="Google Ads", quota=0.30, cpm=55.0, ctr=0.050, qualita=1.30),
    "RND_IT_GOOGLE_SEARCH_LOCALE":    dict(canale="Google Ads", quota=0.16, cpm=48.0, ctr=0.045, qualita=1.20),
    "RND_IT_GOOGLE_PMAX":             dict(canale="Google Ads", quota=0.22, cpm=14.0, ctr=0.020, qualita=0.85,
                                           attiva=(26, 103)),
    "RND_IT_GOOGLE_DISPLAY":          dict(canale="Google Ads", quota=0.12, cpm=6.0,  ctr=0.006, qualita=0.55),
    "RND_IT_GOOGLE_VIDEO_YOUTUBE":    dict(canale="Google Ads", quota=0.08, cpm=9.0,  ctr=0.008, qualita=0.60,
                                           flight=[(10, 17), (48, 55), (86, 95)]),
    # ---- Meta Ads (5) -------------------------------------------------------
    "RND_IT_META_LEAD_GEN_FORMS":     dict(canale="Meta Ads", quota=0.32, cpm=9.0, ctr=0.012, qualita=1.25),
    "RND_IT_META_PROSPECTING_DABA":   dict(canale="Meta Ads", quota=0.28, cpm=7.5, ctr=0.014, qualita=1.10),
    "RND_IT_META_RETARGETING_SITO":   dict(canale="Meta Ads", quota=0.14, cpm=8.5, ctr=0.022, qualita=1.35),
    "RND_IT_META_VIDEO_REELS":        dict(canale="Meta Ads", quota=0.14, cpm=5.0, ctr=0.009, qualita=0.70),
    "RND_IT_META_ADVANTAGE_PLUS":     dict(canale="Meta Ads", quota=0.12, cpm=7.0, ctr=0.013, qualita=0.95,
                                           attiva=(0, 77)),
    # ---- LinkedIn Ads (4) ---------------------------------------------------
    "RND_IT_LINKEDIN_SPONSORED_CONTENT": dict(canale="LinkedIn Ads", quota=0.42, cpm=28.0, ctr=0.0060, qualita=0.95),
    "RND_IT_LINKEDIN_LEAD_GEN_FORMS":    dict(canale="LinkedIn Ads", quota=0.30, cpm=34.0, ctr=0.0085, qualita=1.30),
    "RND_IT_LINKEDIN_VIDEO_EMPLOYER":    dict(canale="LinkedIn Ads", quota=0.16, cpm=24.0, ctr=0.0045, qualita=0.70),
    "RND_IT_LINKEDIN_TEXT_ADS":          dict(canale="LinkedIn Ads", quota=0.12, cpm=18.0, ctr=0.0035, qualita=0.60),
    # ---- Indeed (4) ---------------------------------------------------------
    "RND_IT_INDEED_SPONSORED_JOBS":       dict(canale="Indeed", quota=0.55, cpm=22.0, ctr=0.041, qualita=1.20),
    "RND_IT_INDEED_PPA_STAGIONALI":       dict(canale="Indeed", quota=0.18, cpm=20.0, ctr=0.038, qualita=1.05,
                                               flight=[(22, 34), (40, 50), (74, 86), (92, 100)]),
    "RND_IT_INDEED_DISPLAY_RETE":         dict(canale="Indeed", quota=0.15, cpm=6.0,  ctr=0.005, qualita=0.55),
    "RND_IT_INDEED_RETARGETING_CANDIDATI":dict(canale="Indeed", quota=0.12, cpm=9.0,  ctr=0.018, qualita=1.10),
    # ---- Subito Lavoro (4) --------------------------------------------------
    "RND_IT_SUBITO_SLOT_PREMIUM":      dict(canale="Subito Lavoro", quota=0.45, cpm=11.0, ctr=0.014, qualita=1.00),
    "RND_IT_SUBITO_SPONSORED_ANNUNCI": dict(canale="Subito Lavoro", quota=0.25, cpm=13.0, ctr=0.017, qualita=1.15),
    "RND_IT_SUBITO_DISPLAY_HOME":      dict(canale="Subito Lavoro", quota=0.18, cpm=5.0,  ctr=0.004, qualita=0.50,
                                            flight=[(40, 51), (92, 103)]),
    "RND_IT_SUBITO_RETARGETING":       dict(canale="Subito Lavoro", quota=0.12, cpm=7.0,  ctr=0.012, qualita=1.05),
    # ---- Jooble (4) ---------------------------------------------------------
    "RND_IT_JOOBLE_CPC_ANNUNCI":         dict(canale="Jooble", quota=0.48, cpm=12.0, ctr=0.030, qualita=1.05),
    "RND_IT_JOOBLE_SPONSORED_FEED":      dict(canale="Jooble", quota=0.24, cpm=14.0, ctr=0.028, qualita=1.15),
    "RND_IT_JOOBLE_PROSPECTING_REGIONI": dict(canale="Jooble", quota=0.16, cpm=10.0, ctr=0.022, qualita=0.85,
                                              attiva=(53, 103)),
    "RND_IT_JOOBLE_RETARGETING":         dict(canale="Jooble", quota=0.12, cpm=8.0,  ctr=0.020, qualita=0.95),
    # ---- Altre job board (4) ------------------------------------------------
    "RND_IT_BAKECA_LAVORO_ANNUNCI":  dict(canale="Altre job board", quota=0.34, cpm=8.0,  ctr=0.020, qualita=0.90),
    "RND_IT_TROVOLAVORO_SPONSORED":  dict(canale="Altre job board", quota=0.28, cpm=12.0, ctr=0.018, qualita=1.05),
    "RND_IT_CAREERJET_CPC":          dict(canale="Altre job board", quota=0.22, cpm=9.0,  ctr=0.026, qualita=1.00),
    "RND_IT_TALENT_COM_FEED":        dict(canale="Altre job board", quota=0.16, cpm=10.0, ctr=0.024, qualita=0.95,
                                          attiva=(0, 59)),
}
